...
public class ThreadDemo3 extends Thread {
    ...
    synchronized static private void xc1Ope() {
        int i = 0;
        for (;i < 5 ; i ++) {
            // System.out.println("Thread[" + name + "]: before - " + flag);
            flag ++;
            mSleep(1000);
            System.out.println("Thread: after - " + flag);
        }
    }

    synchronized static private void xc2Ope() {
        int i = 0;
        for (;i < 5 ; i ++) {
            // System.out.println("Thread[" + name + "]: before - " + flag);
            flag ++;
    ...
    public static void main(String[] args) {
        ...
        // Thread t1 = new ThreadDemo3("xc1");
        // t1.start();

        // Thread t2 = new ThreadDemo3("xc2");
        // /*直接调用run()方法*/
        // t2.start();
